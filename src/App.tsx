...
export default function App() {
  ...
  const [calcVolume, setCalcVolume] = useState<number>(120);
  ...
  const t = {
    en: {
      dir: 'ltr',
      heroSub: 'A NEW WAY TO CLEAN',
      heroHeadline: 'LESS WATER. LESS WASTE. MORE AURA.',
      ...
      btnCtaMain: 'EXPLORE THE COLLECTION',
      ...
      sustSub: 'Calculate Your Savings With AURA',
      ...
      faqA4: 'Yes! AURA is pH-balanced (5.5) to match natural skin levels, formulated with plant-derived cleansers and skin-softening ingredients.',
      ...
      rights: '© 2026 AURA. All Rights Reserved.',
      madeLocally: 'Designed & Crafted in Egypt 🇪🇬'
    },
    ar: {
      dir: 'rtl',
      heroSub: 'طريقة جديدة للنظافة والعناية',
      heroHeadline: 'ماء أقل. نفايات أقل. أورا أكثر.',
      ...
      card2Title: 'عبوات خفيفة (Lightweight Refills)',
      ...
      step2Desc: 'املأ الزجاجة بـ 120 مل من الماء الدافئ.',
      ...
      mixWater: 'حجم الماء الدافئ المطلوب',
      ...
      rights: '© 2026 AURA. جميع الحقوق محفوظة.',
  ...
  return (
    <div className={`min-h-screen bg-[#FDFBF7] dark:bg-[#1A1918] text-[#1A1918] dark:text-[#FDFBF7] transition-colors duration-300 ${t.dir === 'rtl' ? 'font-arabic' : 'font-sans'}`} dir={t.dir}>
      ...
      <section id="home" className="relative min-h-[92vh] flex items-center justify-center overflow-hidden py-16 px-4 sm:px-8 bg-[#FDFBF7] dark:bg-[#1A1918]">
        <VideoBackground />
        ...
        <div className="relative z-20 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-start space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#C5A059]/15 border border-[#C5A059]/40 text-[#A37F38] dark:text-[#C5A059] text-xs font-bold tracking-widest uppercase backdrop-blur-md">
              <Sparkles className="w-3.5 h-3.5" />
              <span>{t.heroSub}</span>
            </div>

            {/* Single Headline Max 2 Lines */}
            <h1 className="text-4xl sm:text-6xl lg:text-6xl font-serif font-bold tracking-tight text-[#1A1918] dark:text-white leading-[1.1]">
              {t.heroHeadline}
            </h1>

            <p className="max-w-2xl text-base sm:text-lg text-neutral-700 dark:text-neutral-300 font-normal leading-relaxed">
              {t.heroDesc}
            </p>
            ...
            <div className="pt-2 flex justify-center lg:justify-start">
              <button
                ...
                className="w-full sm:w-auto px-10 py-4 rounded-full bg-[#1A1918] dark:bg-[#C5A059] hover:bg-[#C5A059] dark:hover:bg-[#FDFBF7] text-[#FDFBF7] dark:text-[#1A1918] text-base font-bold tracking-wider uppercase transition-all duration-300 shadow-xl hover:scale-105 active:scale-95 flex items-center justify-center gap-3"
              >
                <span>{t.btnCtaMain}</span>
                <ArrowRight className={`w-5 h-5 ${t.dir === 'rtl' ? 'rotate-180' : ''}`} />
              </button>
            </div>
          </div>

          {/* Hero Right - Visible Product Showcase Image (Above the fold) */}
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md aspect-square rounded-3xl overflow-hidden border-2 border-[#C5A059]/40 shadow-2xl bg-[#F4EFE6] dark:bg-[#2A2928] group">
              <img 
                src="/brand/logo_brand.jpg" 
                alt="AURA Powder Body Wash" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1A1918]/80 via-transparent to-transparent flex items-end p-6">
                <div className="text-white space-y-1">
                  <span className="text-xs font-bold text-[#C5A059] tracking-widest uppercase block">AURA® SIGNATURE</span>
                  <span className="text-lg font-serif font-bold">15g Concentrated Powder Sachet</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* WHY AURA Section */}
      <section id="about" className="py-24 px-4 sm:px-8 bg-[#F4EFE6] dark:bg-[#2A2928]/60">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] dark:text-[#C5A059] uppercase">{t.whyTitle}</h2>
            <h3 className="text-3xl sm:text-5xl font-serif font-bold text-[#1A1918] dark:text-white">{t.whySub}</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Why Card 1 */}
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-[#C5A059]/15 text-[#C5A059] flex items-center justify-center">
                <Feather className="w-7 h-7" />
              </div>
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why1Title}</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              ...
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why2Title}</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              ...
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why3Title}</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              ...
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why4Title}</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              ...
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why5Title}</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-4">
              ...
              <h4 className="text-xl font-bold text-[#1A1918] dark:text-white">{t.why6Title}</h4>
      ...
      <section className="py-24 px-4 sm:px-8 bg-[#FDFBF7] dark:bg-[#1A1918]">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.valTitle}</h2>
            <h3 className="text-3xl sm:text-5xl font-serif font-bold text-[#1A1918] dark:text-white">{t.valSub}</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#C5A059] text-white flex items-center justify-center font-bold text-xl">01</div>
              <h4 className="text-2xl font-serif font-bold text-[#1A1918] dark:text-white">{t.card1Title}</h4>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-base">{t.card1Desc}</p>
            </div>

            <div className="p-8 rounded-3xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#C5A059] text-white flex items-center justify-center font-bold text-xl">02</div>
              <h4 className="text-2xl font-serif font-bold text-[#1A1918] dark:text-white">{t.card2Title}</h4>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-base">{t.card2Desc}</p>
            </div>

            <div className="p-8 rounded-3xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#C5A059] text-white flex items-center justify-center font-bold text-xl">03</div>
              <h4 className="text-2xl font-serif font-bold text-[#1A1918] dark:text-white">{t.card3Title}</h4>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-base">{t.card3Desc}</p>
            </div>

            <div className="p-8 rounded-3xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#C5A059] text-white flex items-center justify-center font-bold text-xl">04</div>
              <h4 className="text-2xl font-serif font-bold text-[#1A1918] dark:text-white">{t.card4Title}</h4>
      ...
      <section id="how-it-works" className="py-24 px-4 sm:px-8 bg-[#1A1918] text-white">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.howTitle}</h2>
            <h3 className="text-3xl sm:text-5xl font-serif font-bold text-white">{t.howSub}</h3>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 space-y-4 relative">
              <span className="text-5xl font-extrabold text-[#C5A059]/40">01</span>
            ...
            <div className="p-8 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 space-y-4 relative">
              <span className="text-5xl font-extrabold text-[#C5A059]/40">02</span>
            ...
            <div className="p-8 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 space-y-4 relative">
              <span className="text-5xl font-extrabold text-[#C5A059]/40">03</span>
            ...
            <div className="p-8 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 space-y-4 relative">
              <span className="text-5xl font-extrabold text-[#C5A059]/40">04</span>
      ...
      <section id="products" className="py-24 px-4 sm:px-8 bg-[#F4EFE6] dark:bg-[#2A2928]/60">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.prodTitle}</h2>
      ...
      <section className="py-24 px-4 sm:px-8 bg-[#FDFBF7] dark:bg-[#1A1918]">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <span className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.storyTitle}</span>
          <h3 className="text-3xl sm:text-5xl font-serif font-bold text-[#1A1918] dark:text-white">{t.storyHeading}</h3>
          
          <div className="p-8 sm:p-12 rounded-3xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 space-y-6 text-lg text-neutral-700 dark:text-neutral-300 leading-relaxed max-w-3xl mx-auto shadow-sm">
            <p className="font-serif font-bold text-2xl text-[#1A1918] dark:text-[#C5A059]">"{t.storyText1}"</p>
            <p>{t.storyText2}</p>
          </div>
        </div>
      </section>
      ...
      <section id="sustainability" className="py-24 px-4 sm:px-8 bg-[#1A1918] text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.sustTitle}</h2>
            <h3 className="text-3xl sm:text-5xl font-serif font-bold text-white">{t.sustSub}</h3>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 space-y-6">
              <h4 className="text-xl font-bold text-white">Interactive Eco Simulator</h4>
              <div className="space-y-4">
                <div>
                  <label className="block text-xs text-neutral-300 mb-1">{t.calcPeopleLabel} {ecoPeople}</label>
                  <input 
                ...
                <div>
                  <label className="block text-xs text-neutral-300 mb-1">{t.calcMonthsLabel} {ecoMonths}</label>
                  <input 
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="p-6 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 flex flex-col justify-between">
                <Trash2 className="w-8 h-8 text-[#C5A059] mb-4" />
                <div>
                  <span className="text-4xl font-extrabold text-white block">{(ecoPeople * ecoMonths * 2).toLocaleString()}</span>
                  <span className="text-xs text-neutral-300 font-medium">{t.plasticSaved}</span>
                </div>
              </div>

              <div className="p-6 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 flex flex-col justify-between">
                <Droplets className="w-8 h-8 text-[#C5A059] mb-4" />
                <div>
                  <span className="text-4xl font-extrabold text-white block">{(ecoPeople * ecoMonths * 0.48).toFixed(1)} L</span>
                  <span className="text-xs text-neutral-300 font-medium">{t.waterSaved}</span>
                </div>
              </div>

              <div className="p-6 rounded-3xl bg-[#2A2928] border border-[#C5A059]/30 flex flex-col justify-between">
                <Trees className="w-8 h-8 text-[#C5A059] mb-4" />
                <div>
                  <span className="text-4xl font-extrabold text-white block">{(ecoPeople * ecoMonths * 0.35).toFixed(1)} kg</span>
                  <span className="text-xs text-neutral-300 font-medium">{t.co2Saved}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-4 sm:px-8 bg-[#F4EFE6] dark:bg-[#2A2928]/60">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.mixTitle}</h2>
            <h3 className="text-3xl sm:text-4xl font-serif font-bold text-[#1A1918] dark:text-white">{t.mixSub}</h3>
          </div>

          <div className="p-8 sm:p-12 rounded-3xl bg-[#FDFBF7] dark:bg-[#1A1918] border border-[#C5A059]/30 shadow-xl space-y-8">
            <div>
              <label className="block text-sm font-bold text-[#1A1918] dark:text-white mb-2">
                {t.mixLabel} <span className="text-[#C5A059] font-bold text-lg">{calcVolume} ml</span>
              </label>
              <input 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-neutral-200 dark:border-neutral-800">
              <div className="p-6 rounded-2xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 text-center">
                <span className="block text-xs font-bold text-[#C5A059] uppercase tracking-wider mb-1">{t.mixPowder}</span>
                <span className="text-3xl font-extrabold text-[#1A1918] dark:text-white">{((calcVolume / 120) * 15).toFixed(1)} g</span>
              </div>

              <div className="p-6 rounded-2xl bg-[#F4EFE6] dark:bg-[#2A2928] border border-[#C5A059]/30 text-center">
                <span className="block text-xs font-bold text-[#C5A059] uppercase tracking-wider mb-1">{t.mixWater}</span>
                <span className="text-3xl font-extrabold text-[#1A1918] dark:text-white">{calcVolume} ml</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* FAQ Section */}
      <section className="py-24 px-4 sm:px-8 bg-[#FDFBF7] dark:bg-[#1A1918] border-t border-neutral-200 dark:border-neutral-800">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">{t.faqTitle}</h2>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="rounded-2xl border border-[#C5A059]/30 overflow-hidden">
                <button
                  onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                  className="w-full p-6 text-start font-bold text-lg text-[#1A1918] dark:text-white flex justify-between items-center gap-4 bg-[#FDFBF7] dark:bg-[#1A1918] hover:bg-[#F4EFE6] dark:hover:bg-[#2A2928] transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`w-5 h-5 text-[#C5A059] transition-transform duration-300 ${openFaq === idx ? 'rotate-180' : ''}`} />
                </button>
                {openFaq === idx && (
                  <div className="p-6 pt-0 bg-[#FDFBF7] dark:bg-[#1A1918] text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed border-t border-neutral-200 dark:border-neutral-800">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* Contact & Professional Brand Footer */}
      <footer id="contact" className="py-20 px-4 sm:px-8 bg-[#1A1918] text-white border-t border-neutral-800">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <img src="/brand/logo_brand.jpg" alt="AURA Logo" className="w-10 h-10 object-cover rounded-full border border-[#C5A059]/40" />
                <span className="text-3xl font-serif font-bold text-white tracking-widest">AURA<sup>®</sup></span>
              </div>
            ...
            {/* Links Col */}
            <div className="space-y-4">
              <h5 className="text-xs font-bold tracking-widest text-[#C5A059] uppercase">Navigation</h5>
          ...
          {/* Standardized Copyright Footer */}
          <div className="pt-8 border-t border-neutral-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-neutral-400">
